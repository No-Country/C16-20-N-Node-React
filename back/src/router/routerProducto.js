...
//✔️ - Finalizado
routerProducto.get("/producto/restaurant/:id", async (req, res) => {
  try {
    const id = req.params.id;
    const productoRestaurant = await listarProductosPorRestaurant(id);
...
//✔️ - Finalizado
routerProducto.post(
  "/producto/registro/:id", async (req, res) => {
    try {
