...
import { listarProductos, listarProductosPorNombre, listarProductoPorId, listarProductosPorRestaurant, crearProducto, editarProducto } from "../controllers/productosController.js";
...
routerProducto.get("/producto/restaurant/:id_restaurant", async (req, res) => {
    try {
        ...
        const productoRestaurant = await listarProductosPorRestaurant(id_restaurant);
