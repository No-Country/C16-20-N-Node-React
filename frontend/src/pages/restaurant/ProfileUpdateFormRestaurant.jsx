...
const ProfileUpdateFormRestaurant = () => {
    ...
    useEffect(() => {
        ...
        const matchedProfile = storedProfileUsers.find(profile => profile.mail === storedUserCurrent.mail);
    ...
    useEffect(() => {
        if (matchedProfile) {
            ...
            setCategory(matchedProfile.category || '');
    ...
    const handleSubmit = async (event) => {
        ...
        const updatedProfiles = storedProfileUsers.map(profile => {
            if (profile.mail === storedUserCurrent.mail) {
                return {
                    ...profile,
                    name,
                    address,
        ...
        console.log("Perfil actualizado:", updatedProfiles);

        localStorage.setItem('ProfileUsers', JSON.stringify(updatedProfiles));
...
export default ProfileUpdateFormRestaurant;